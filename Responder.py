...
parser.add_option('-P', '--ProxyAuth',       action="store_true", help="Force NTLM (transparently)/Basic (prompt) authentication for the proxy. WPAD doesn't need to be ON. Default: False", dest="ProxyAuth_On_Off", default=False)
...
parser.add_option('-c', '--config', action="store", help="Alternate configuration file", dest="ConfigurationFile")
