...
- Built-in HTTP Auth server
  ...
  This server supports NTLMv1, NTLMv2 hashes *and* Basic Authentication.
  This server was successfully tested on IE 6 to IE 11, Edge, Firefox,
  Chrome, Safari.
...
- Built-in DCE-RPC Auth server
  ...
  to set the option `-d` (NBT-NS queries for DCE-RPC server lookup
