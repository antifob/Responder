...
class Settings:
    ...
    def populate(self, options):
        ...
        if options.ConfigurationFile is None:
            ...
            print(options.ConfigurationFile)
            config.read(options.ConfigurationFile)
        ...
        # Db File
        self.DatabaseFile    = config.get('Responder Core', 'Database')

        # Log Files
        self.LogDir = config.get('Responder Core', 'LogDir')
